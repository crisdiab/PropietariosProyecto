...
{
    public partial class DardeBajaRepresentante : Form
    {
        public DardeBajaRepresentante()
        {
            InitializeComponent();
            this.CenterToScreen();
        }
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            this.rEPRESENTANTEBindingSource.EndEdit();
            this.tableAdapterManager.UpdateAll(this.grisGrisDataSet);
            MessageBox.Show("Representante atualizado correctamente", "Confirmación", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
    }
}
